...
<html lang="zh-Hant">
  ...
  <body>
    ...
    <script>
      ...
      var fetch_url = "http://notes.webmix.cc/ajax/teach/simple.php";
      //var fetch_url = "http://notes.webmix.cc/ajax/teach/simple_500.php";
      //var fetch_url = "http://localhost:3000/ajax/no_file.html";
      //var fetch_url = "http://notes.webmix.cc/ajax/teach/simple_no.php";
      
      fetch(fetch_url).then(function(response){ // 接收到回傳的物件
