...
完成版的 JS 版本(未串接 API)： [https://alldata.sgp1.digitaloceanspaces.com/sample/assignment\_js\_only.zip](https://alldata.sgp1.digitaloceanspaces.com/sample/assignment_js_only.zip)
